...
public class TimetableController {
	...
	/*
	 * @PostMapping("/saveTimetable") public String
	 * saveTimetable(@ModelAttribute("timetable") Timetable theTimetable) {
	 * timetableService.saveTimetable(theTimetable); return "redirect:/list"; }
	 */
	 ...
	 * timetableService.deleteTimetable(theId); return "redirect:/list"; }
	 */}
