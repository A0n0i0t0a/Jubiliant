					...
					<div class="row">
						<div class="col-sm-8">
							...
							<ul>
								...
								<li>Submit weekly report by last working day of week!</li>
						...
						<br> <br>
						<button class="button">
						<a href="/ums/timetable/list">View TimeTable</a></button>
						...
						<button class="button">
							<a href="/ums/assign/viewAssignment?studentId= ${usr.student.id}">Upload Assignments</a>
						</button>
						<!--Register Modal -->
										...
										<form action="/ums/student/saveStudent" method="post"
											...
											<div class="form-group">
												<label for="studentLastName" class="control-label">
													...
													id="studentLastName" name="studentLastName"
											...
											<div class="form-group w3ls-opt">
												...
												<label class="w3layouts"> <input type="radio"
													...
													name="studentGender" value="male" checked>Male
												</label> <label class="w3layouts label2"> <input
													type="radio" name="studentGender" id="studentGender"
													name="studentGender" value="female">Female
												</label>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label for="studentFatherName" class="control-label">Father's
													...
													id="studentFatherName" name="studentFatherName"
											...
											<div class="form-group">
												<label for="studentMotherName" class="control-label">Mother's
													Name:</label> <input type="text" class="form-control"
													id="studentMotherName" name="studentMotherName"
